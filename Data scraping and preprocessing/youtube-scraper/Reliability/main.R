...
# Read rater codings
coder_1_data <- read_excel("C:/D/VIT CHN/Internships/Tamil_Argumentation/Data Scraper/youtube-scraper/Reliability/Sujith_Jallikattu.xlsx")
coder_2_data <- read_excel("C:/D/VIT CHN/Internships/Tamil_Argumentation/Data Scraper/youtube-scraper/Reliability/Rithvik_Jallikattu.xlsx")

# Rename column names
new_colnames <- c(
    "S.No", "Video.URL", "Topic", "Comments", "Content", "Language",
    "Quality", "Stance", "Argumentation", "Comment", "Tone",
